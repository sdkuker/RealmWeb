...
(function(){
    ...
    BootstrapDialog.prototype = {
        ...
        createModalDialog: function() {
            return $('<div class="modal-dialog custom-modal-margin"></div>');
        },
        ...
        createModalFooter: function() {
            return $('<div class="modal-footer custom-modal-footer-padding"></div>');
        },
     ...
     * @returns the created dialog instance
     */
    BootstrapDialog.alert = function(message,callback,title,cssClass) {
        var options = {};
        var defaultOptions = {
            type: BootstrapDialog.TYPE_PRIMARY,
        ...
        return new BootstrapDialog({
            ...
            buttons: [{
                    ...
                    cssClass : 'btn-primary pt-alert-button-no',
     ...
     * @returns the created dialog instance
     */
    BootstrapDialog.confirm = function(title,message, callback,cssClass,noButtonLabel,yesButtonLabel) {
        return new BootstrapDialog({
            ...
            buttons: [{
                    label: yesButtonLabel?yesButtonLabel:'Yes',
                    ...
                    label: noButtonLabel?noButtonLabel:'No',
